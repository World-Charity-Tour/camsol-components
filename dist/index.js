...
var Button = function (_a) {
  var text = _a.text,
    ...
    customizeVariantProps = _a.customizeVariantProps,
    hoverBgColor = _a.hoverBgColor,
    color = _a.color,
    setBtnActiveStateIndex = _a.setBtnActiveStateIndex,
    index = _a.index,
    rounded = _a.rounded,
    width = _a.width,
    height = _a.height,
              ...
              __assign(
                {
                  ...
                  className: ''
                    .concat(styles.badge, ' ')
                    .concat(rounded !== undefined && rounded ? styles.rounded : ''),
                  style: {
                    background: bgColor,
                    color: color,
                  },
                },
                { children: [iconLeft, text, iconRight] },
              ),
            ),
          })
        : jsxRuntime.jsx(jsxRuntime.Fragment, {
