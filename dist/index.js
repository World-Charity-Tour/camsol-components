...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: type === ButtonType.BADGE ? (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("button", __assign({ disabled: disabled, className: "".concat(styles.badge, " ").concat(rounded !== undefined && rounded ? styles.rounded : ''), style: {
                    background: bgColor,
                    color: color,
                } }, { children: [iconLeft, text, iconRight] })) })) : (jsxRuntime.jsx(jsxRuntime.Fragment, { children: customizeVariantProps !== undefined && customizeVariantProps ? (jsxRuntime.jsxs("button", __assign({ onClick: onClick, onMouseEnter: function () {
                    setHoverState(true);
                    ...
                    : type === ButtonType.OUTLINED
                        ...
                        : type === ButtonType.TEXT
                            ? styles.text
                            : styles.underlined) }, { children: [iconLeft, text, iconRight] }))) : (jsxRuntime.jsxs("button", __assign({ onClick: onClick, disabled: disabled, style: {
                    height: height !== undefined ? height : '51px',
                    width: width !== undefined ? width : 'fit-content',
