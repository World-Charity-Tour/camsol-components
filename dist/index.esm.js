...
var Button = function (_a) {
    ...
    var _b = reactExports.useState(false), hoverState = _b[0], setHoverState = _b[1];
    return (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: type === ButtonType.BADGE ? (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsxs("button", __assign({ disabled: disabled, className: "".concat(styles.badge, " ").concat(rounded !== undefined && rounded ? styles.rounded : ''), style: {
                    background: bgColor,
                    color: color,
                } }, { children: [iconLeft, text, iconRight] })) })) : (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: customizeVariantProps !== undefined && customizeVariantProps ? (jsxRuntimeExports.jsxs("button", __assign({ onClick: onClick, onMouseEnter: function () {
                    setHoverState(true);
                    ...
                    : type === ButtonType.OUTLINED
                        ...
                        : type === ButtonType.TEXT
                            ? styles.text
                            : styles.underlined) }, { children: [iconLeft, text, iconRight] }))) : (jsxRuntimeExports.jsxs("button", __assign({ onClick: onClick, disabled: disabled, style: {
                    height: height !== undefined ? height : '51px',
                    width: width !== undefined ? width : 'fit-content',
